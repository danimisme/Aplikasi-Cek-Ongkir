...
class HomeView extends GetView<HomeController> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('Cek Ongkir', style: TextStyle(color: Colors.white, fontWeight: FontWeight.bold)),
      ...
      body: ListView(
        ...
        children: [
          ...
          Obx(() => DropdownSearch<City>(
                enabled: controller.provAsalId.value != "0",
                compareFn: (item1, item2) => item1 == item2,
                items: (f, s) =>
          ...
          SizedBox(height: 20),
          Obx(() => DropdownSearch<City>(
                enabled: controller.provTujuanId.value != "0",
                compareFn: (item1, item2) => item1 == item2,
                items: (f, s) =>
